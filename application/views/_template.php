    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="<?= base_url() ?>" class="logo">
                ...
                <span class="logo-lg">Kasir Satria Jaya</span>
            </a>
                        ...
                        <li class="treeview <?= $this->uri->segment(1) == 'sale'
                            ...
                            <ul class="treeview-menu">
                                <li class="<?= $this->uri->segment(1) == 'sale' ? 'active' : null ?>">
                                    <a href="<?= site_url('sale') ?>"><i class="fa fa-circle-o text-green"></i> <b>Kasir</b></a>
                                </li>
                        ...
                        <li class="treeview <?= $this->uri->segment(1) == 'report' ? 'active' : null ?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?= $this->uri->segment(1) == 'report'
                                    ...
                                    <a href="<?= site_url('report/stock') ?>"><i class="fa fa-circle-o"></i> Barang</a>
                                </li>
                            </ul>
                        </li>
                    <?php } ?>
