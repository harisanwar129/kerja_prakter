<section class="content-header">
    <p style="font-size: 20px;margin-left:0%">Sytem Kasir</small>
        </h1>
        <ol class="breadcrumb">
                ...
                <div>
                    <table width="100%">
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="hidden" id="sub_total" value="<?= $subtotal ?>" class="form-control" readonly>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="hidden" id="grand_total" class="form-control" readonly>
                                </div>
                            </td>
                        </tr>
                    </table>
                        ...
                        foreach ($item as $i => $data) { ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button id="select" data-barcode="<?= $data->barcode ?>" data-itemid="<?= $data->item_id ?>" data-price="<?= $data->price ?>" data-stock="<?= $data->stock ?>" class="btn btn-xs btn-info">
